<?php
 if(isset($_POST['excluded_for_attn_check']) ){
    ...
    if($excluded_for_attn_check === "exclude_participant"){
     ...
     $headers = "participant_id, system_generated_id, experiment_sequence, experiment_browser, experiment_browser_version, experiment_os, timestamp, experiment_duration";
     if (!$exists){
     ...
     $form_data = PHP_EOL."$participant_id, $system_generated_id, $experiment_sequence, $browser_name, $browser_version, $operating_system, $timestamp, $experiment_duration";
