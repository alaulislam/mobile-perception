                        ...
                        <div class="slideshow-container">
                            ...
                            <div id="gif_trial_images_T2S3D1">
                                <img  src="img/exp_start2.jpg"/>
                                   <button class="btn" id="btn_trial_images_T2S3D1">Start!</button>
                             </div> 
                                        ...
                                        <div class="trial_images_T2S3D1" id="T2S3D1_<?php echo $i_T2S3D1; ?>_<?php echo $practice_trial_shuffle_T2S3D1[$i_T2S3D1] ?>" >
                                          <img id="img_T2S3D1_<?php echo $i_T2S3D1 ?><?php echo $practice_trial_shuffle_T2S3D1[$i_T2S3D1] ?>" src="img/<?php echo $chart_type_T2S3D1; ?>/<?php echo $practice_trial_shuffle_T2S3D1[$i_T2S3D1] ?>.png"/>
                                            <!-- <div class="d-flex justify-content-center">
                                                <div class="caption center-block feed-caption" id="feedback_correct_T2S3D1_<?php echo $i_T2S3D1; ?><?php echo $practice_trial_shuffle_T2S3D1[$i_T2S3D1] ?>" style="">Correct!</div>
                                            </div>
                                            <div class="d-flex justify-content-center">
                                                <div class="caption center-block feed-caption" id="feedback_error_T2S3D1_<?php echo $i_T2S3D1; ?><?php echo $practice_trial_shuffle_T2S3D1[$i_T2S3D1] ?>" style="">Wrong!</div>
                                            </div> -->
                                        </div>  
                              <?php } ?>
                              </div>
...
$("#btn_no_T2S3D1").click(function(){
    ...
    button_disable_T2S3D1();
    // $(".trial_images_T2S3D1").on('click touch', function () {
    //     next_images_T2S3D1(1);
    //     $("#feedback_correct_T2S3D1_"+current_trial_image_name_T2S3D1).hide();
    //     $("#feedback_error_T2S3D1_"+current_trial_image_name_T2S3D1).hide();
    //  });
