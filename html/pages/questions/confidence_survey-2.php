    ...
    <div class="form-group" id="form_likert">
        ...
        <div>
          <div class="form-check">
            <input type="radio" class="form-check-input" value="1" name="q" id="radio_second_set_cs_completely_confident">
          ...
          <div class="form-check">
            <input type="radio" class="form-check-input" value="2" name="q" id="radio_second_set_cs_fairly_confident">
            <label class="form-check-label" for="radio_second_set_cs_fairly_confident" style="margin-left:6px;">Fairly confident</label>
          </div>
          <div class="form-check">
            <input type="radio" class="form-check-input" value="3" name="q" id="radio_second_set_cs_somewhat_confident">
            <label class="form-check-label" for="radio_second_set_cs_somewhat_confident" style="margin-left:6px;">Somewhat confident</label>
          </div>
          <div class="form-check">
            <input type="radio" class="form-check-input" value="4" name="q" id="radio_second_set_cs_slightly_confident">
            <label class="form-check-label" for="radio_second_set_cs_slightly_confident" style="margin-left:6px;">Slightly confident</label>
          </div>
          <div class="form-check">
            <input type="radio" class="form-check-input" value="5" name="q" id="radio_second_set_cs_not_confident">
