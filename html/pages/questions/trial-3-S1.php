...
weekdays (Mon-Fri)?</h2>
      ...
      <div class="d-flex justify-content-center">
            <div class = "btn-group-justified btn-group-lg btn-group-vertical">
              <button type="button" id="btn_saturday_T3S1" class="btn btn-info">Sat</button>
              <button type="button" id="btn_sunday_T3S1" class="btn btn-info" style="margin-top: 15px;">Sun</button>
            </div>
    </div>
...
function button_enable_T2S3(){
    $('#btn_saturday_T3S1').prop('disabled', false);
    $('#btn_sunday_T3S1').prop('disabled', false);
}
function button_disable_T3S1(){
    $('#btn_saturday_T3S1').prop('disabled', true);
    $('#btn_sunday_T3S1').prop('disabled', true);     
}
...
$("#btn_sunday_T3S1").click(function(){
...
$("#btn_saturday_T3S1").click(function(){
    var current_trial_image_name_T3S1 = $('#current_trial_image_name_T3S1').val();
    time_counter_left = performance.now();
    // console.log("Left button clicked" + (time_counter_left - last_time_count) + " milliseconds.")
    if( image_index_T3S1 === trial_image_count_T3S1){
