    ...
    <div class="d-flex justify-content-center task-description">
      ...
      <div class="d-flex justify-content-center">
            <div class = "btn-group-justified btn-group-lg btn-group-horizontal">
              <button type="button" id="btn_no_P_T2S3" class="btn btn-info">No</button>
              <button type="button" id="btn_yes_P_T2S3" class="btn btn-info" style="margin-right: 15px;">Yes</button>
            </div>
    </div>
