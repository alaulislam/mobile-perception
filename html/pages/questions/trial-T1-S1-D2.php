...
<?php
  ...
  $practice_trial_shuffle_T1S1D2 = handleImageFIle_S1($img_start_T1S1D2, $img_end_T1S1D2, $chart_type_T1S1D2);
    
  function handleImageFIle_S1($img_start_T1S1D2, $img_end_T1S1D2, $chart_type_T1S1D2){
...
<div class="row justify-content-center align-items-center">
  <div class="col-12">
    <!-- <div class="d-flex justify-content-center task-description">
          <h2 class="legend" id="init_instruction_T1S1D2">On which day did you sleep longer, Saturday or Sunday?</h2>
      </div> -->
                ...
                <input type="hidden" id="current_trial_image_name_T1S1D2" value="">
                    <div class="slideshow-container">
                        ...
                        <div id="gif_trial_images_T1S1D2">
                                   ...
                                   <button class="btn" id="btn_trial_images_T1S1D2">Start!</button>
                             </div> 
                                ...
                                {  ?>  
                                  ...
                                  <?php } ?>
                                    ...
                                    <div class="trial_images_T1S1D2" id="T1S1D2_<?php echo $i_T1S1D2; ?>_<?php echo $practice_trial_shuffle_T1S1D2[$i_T1S1D2] ?>" >
                                      <img id="img_T1S1D2_<?php echo $i_T1S1D2 ?><?php echo $practice_trial_shuffle_T1S1D2[$i_T1S1D2] ?>" src="img/<?php echo $chart_type_T1S1D2; ?>/<?php echo $practice_trial_shuffle_T1S1D2[$i_T1S1D2] ?>.png"/>
                                    </div>  
                          <?php } ?>
...
function show_images_T1S1D2(n){
      if( image_index_T1S1D2 > trial_image_count_T1S1D2){
        ...
        // alert(attention_check_count_T1S1D2);
        return;
      }
      var i;
