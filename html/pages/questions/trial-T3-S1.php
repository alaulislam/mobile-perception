...
#gif_trial_images_T3S1 .btn:hover {
...
weekdays (Mon-Fri)?</h2>
      ...
      <div class="d-flex justify-content-center" style="margin-top: 10px;">
                    <input type="hidden" id="current_trial_image_name_T3S1" value="">
                        <div class="slideshow-container">
                            ...
                            <div id="gif_trial_images_T3S1">
                                <img  src="img/exp_start2.jpg"/>
                                   <button class="btn" id="btn_trial_images_T3S1">Start!</button>
                             </div> 
                             <div id="div_trial_images_T3S1" style="display:none"> 
                            <?php
      ...
      <div class="d-flex justify-content-center">
            <div class = "btn-group-justified btn-group-lg btn-group-horizontal">
              <button type="button" id="btn_no_T3S1" class="btn btn-info">No</button>
              <button type="button" id="btn_yes_T3S1" class="btn btn-info" style="margin-right: 15px;">Yes</button>
            </div>
    </div>
...
$(document).ready(function() {
  ...
  $("#gif_trial_images_T3S1").click(function(){
    $("#gif_trial_images_T3S1").hide();
    $('#div_trial_images_T3S1').show();
    $("#btn_yes_T3S1").show();
    $("#btn_no_T3S1").show();
...
function button_enable_T2S3(){
    ...
    $('#btn_no_T3S1').prop('disabled', false);
}
function button_disable_T3S1(){
    $('#btn_yes_T3S1').prop('disabled', true);
    $('#btn_no_T3S1').prop('disabled', true);     
}
...
$("#btn_no_T3S1").click(function(){
    ...
    var sliced_current_trial_image_name = current_trial_image_name_T3S1.slice(current_trial_image_name_T3S1.lastIndexOf('t3') + 2);
