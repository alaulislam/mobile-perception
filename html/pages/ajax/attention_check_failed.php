...
if( isset($_POST['test_string']) ){
      // $test_string   = json_decode($_POST['test_string'], true);
...
<div class="row">
  ...
  <h1> <?php echo $test_string; ?> </h1>
    ...
    <p id="att_failed">
      We asked <em>On which day did you sleep longer, Saturday or Sunday?</em>. 
      The right answer was <em style="color: green"> Sunday</em>
      <div class="text-center">
                  <img  src="img/attention/T1_S1/ATTN-s1_113_t1rt2lt3r.png" class="img-thumbnail" style="width: 213px !important;"/>
        </div>
      but you chose <em style="color: red">Saturday</em>.
    </p>
