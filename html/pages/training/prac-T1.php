      ...
      <div class="container">
         ...
         <div id="task_explanation_T1">
            <div class="visible task_explanation_T1_slide">
               ...
               <p class="text-justify"><b>Your question to answer:</b> On which day did you sleep longer, Saturday or Sunday?</p>
               ...
               <div class="row">
                  <div class="col-sm-12">
                     ...
                     <button type="button" class="btn btn-warning task_explanation_T1_understand_btn" style="width:80%">I understand</button>
                  </div>
               </div>
            </div>
            <div class="task_explanation_T1_slide" style="margin-top:-10px;">
               <p class="text-justify" style="margin-top:-10px;"><b>How to do it:</b> Comparing the bar width of Saturday & Sunday and choose the longer one. For example,</p>
