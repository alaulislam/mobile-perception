...
<?php
   ...
   $trial_shuffle_P_T1S2D3 = handleImageimage_file_name_P_T1S2D3($img_start_P_T1S2D3, $img_end_P_T1S2D3, $chart_type_P_T1S2D3);
     
   function handleImageimage_file_name_P_T1S2D3($img_start_P_T1S2D3, $img_end_P_T1S2D3, $chart_type_P_T1S2D3){
...
<div class="row">
   <div class="col">
      <div class="container">
         <div class=mt-3></div>
         <h5 id="header_q_P_T1S2D3">On which day did you sleep longer, Saturday or Sunday?</h5>
...
<script type="text/javascript">
   ...
   $('body').on('next', function(e, type){
     ...
     event.preventDefault();
      ...
      var experiment_order_P_T1S2D3            = 'T1-S2-D3';
