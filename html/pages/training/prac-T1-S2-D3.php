            ...
            <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
               <div class="modal-content h-auto rounded-right">
                  ...
                  <div class="modal-footer">
                     ...
                     <button type="button" class="btn btn-dark border rounded-pill shadow-sm mb-1" id="btn_next_correct_modal_P_T1S2D3">NEXT</button>
                  </div>
               </div>
            </div>
         </div>
            ...
            <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
               <div class="modal-content h-auto rounded-right">
                  ...
                  <div class="modal-footer">
                     ...
                     <button type="button" class="btn btn-dark border rounded-pill shadow-sm mb-1" id="btn_next_error_modal_P_T1S2D3">NEXT</button>
                  </div>
               </div>
            </div>
         </div>
