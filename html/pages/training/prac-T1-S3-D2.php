...
<?php
   ...
   $experiment_order_P_T1S3D2 ="T1-S3-D2";
   ...
   $trial_shuffle_P_T1S3D2 = handleImageimage_P_T1S3D2($img_start_P_T1S3D2, $img_end_P_T1S3D2, $chart_type_P_T1S3D2);
     
   function handleImageimage_P_T1S3D2($img_start_P_T1S3D2, $img_end_P_T1S3D2, $chart_type_P_T1S3D2){
...
<div class="row">
   <div class="col">
      <div class="container">
         <div class=mt-3></div>
         <h5 id="header_question_P_T1S3D2">On which day did you sleep longer, Saturday or Sunday?</h5>
            ...
            <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
               <div class="modal-content h-auto rounded-right">
                  ...
                  <div class="modal-footer">
                     ...
                     <button type="button" class="btn btn-dark border rounded-pill btn-wider w-100" id="btn_next_correct_modal_P_T1S3D2">NEXT</button>
                  </div>
               </div>
            </div>
         </div>
            ...
            <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
               <div class="modal-content h-auto rounded-right">
                  ...
                  <div class="modal-footer">
                     ...
                     <button type="button" class="btn btn-dark border rounded-pill btn-wider w-100" id="btn_next_error_modal_P_T1S3D2">NEXT</button>
                  </div>
               </div>
            </div>
         </div>
...
<script type="text/javascript">
   ...
   $(document).ready(function() { 
     ...
     $("#btn_<?php echo $id;?>").hide();
       var time_counter_init_P_T1S3D2 = performance.now();
       set_current_time_P_T1S3D2(time_counter_init_P_T1S3D2);
      //  console.log("Initital time counter", time_counter_init_P_T1S3D2);
   ...
   $('body').on('next', function(e, type){
     ...
     event.preventDefault();
      ...
      var experiment_order_P_T1S3D2            = '<?php echo $experiment_order_P_T1S3D2;?>';
