...
<?php
   ...
   $trial_shuffle_P_T3S2D2 = handleImageimage_file_name_P_T3S2D2($img_start_P_T3S2D2, $img_end_P_T3S2D2, $chart_type_P_T3S2D2);
     
   function handleImageimage_file_name_P_T3S2D2($img_start_P_T3S2D2, $img_end_P_T3S2D2, $chart_type_P_T3S2D2){
            ...
            <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
               <div class="modal-content h-auto rounded-right">
                  ...
                  <div class="modal-footer">
                     ...
                     <button type="button" class="btn btn-dark border rounded-pill shadow-sm mb-1" id="btn_next_correct_modal_P_T3S2D2">NEXT</button>
                  </div>
               </div>
            </div>
         </div>
            ...
            <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
               <div class="modal-content h-auto rounded-right">
                  ...
                  <div class="modal-footer">
                     ...
                     <button type="button" class="btn btn-dark border rounded-pill shadow-sm mb-1" id="btn_next_error_modal_P_T3S2D2">NEXT</button>
                  </div>
               </div>
            </div>
         </div>
...
<script type="text/javascript">
   ...
   $(document).ready(function() {
      $("#btn_<?php echo $id;?>").hide();
       ...
       $("#btn_no_P_T3S2D2").click(function(){
           ...
           var sliced_current_trial_image_name_P_T3S2D2 = current_trial_image_name_P_T3S2D2.slice(current_trial_image_name_P_T3S2D2.lastIndexOf('t2') + 2);
   ...
   $('body').on('next', function(e, type){
     ...
     var experiment_order_P_T3S2D2            = 'T3-S2-D2';
