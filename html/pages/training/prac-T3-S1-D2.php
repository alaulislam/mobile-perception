...
<?php
   ...
   function handleImage_P_T3S1D2($img_start_P_T3S1D2, $img_end_P_T3S1D2, $chart_type_P_T3S1D2){
       ...
       for($i =0, $k = $img_start_P_T3S1D2; $k <= $img_end_P_T3S1D2; $k += 4, $i++){
         if(isset($images[$k]))
         {
         ...
         <div class="d-flex justify-content-center" id="div_trainging_images_P_T3S1D2">
            ...
            <div class="slideshow-container">
               <div class="slideshow-inner justify-content-center">
                  <?php
                     for( $i_P_T3S1D2 = 0; $i_P_T3S1D2 < $total_image_P_T3S1D2; $i_P_T3S1D2++)
                     {  ?>                                     
                  <div class="trial_images_P_T3S1D2" id="P-T3S1D2-<?php echo $i_P_T3S1D2; ?>-<?php echo $trial_shuffle_P_T3S1D2[$i_P_T3S1D2] ?>">
                     <img id="img-P-T3S1D2-<?php echo $i_P_T3S1D2 ?>-<?php echo $trial_shuffle_P_T3S1D2[$i_P_T3S1D2] ?>" src="img/<?php echo $chart_type_P_T3S1D2 ?>/<?php echo $trial_shuffle_P_T3S1D2[$i_P_T3S1D2] ?>.png"/>
                  </div>
                  <?php } ?>
               </div>
            </div>
            ...
            <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
               <div class="modal-content h-auto rounded-right">
                  ...
                  <div class="modal-footer">
                     <p class="d-none" id="btn_next_correct_modal_message_P_T3S1D2">Training is over, wait a moment please!</p>
                     <button type="button" class="btn btn-dark border rounded-pill btn-wider w-100" id="btn_next_correct_modal_P_T3S1D2">NEXT</button>
                  </div>
               </div>
            </div>
         </div>
         <div class="modal left xs fade" id="modal_error_ans_P_T3S1D2" tabindex="-1" role="dialog" aria-labelledby="top_modal" data-keyboard="false" data-backdrop="static">
            <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
               <div class="modal-content h-auto rounded-right">
                  <div class="mt-1"></div>
                  <div class="modal-body text-center">
                  ...
                  <div style="margin-top:-15px"></div>
                  <div class="modal-footer">
                     <p class="d-none" id="btn_next_error_modal_message_P_T3S1D2">Training is over, wait a moment please!</p>
                     <button type="button" class="btn btn-dark border rounded-pill btn-wider w-100" id="btn_next_error_modal_P_T3S1D2">NEXT</button>
                  </div>
               </div>
            </div>
         </div>
...
<script type="text/javascript">
   var trial_image_count_P_T3S1D2 = <?php echo $total_image_P_T3S1D2; ?>;
   var viz_size_P_T3S1D2 = '<?php echo $chart_type_P_T3S1D2 ?>';
   var stimuli_P_T3S1D2 = viz_size_P_T3S1D2.toLowerCase();
   var image_index_P_T3S1D2 = 1;
   
   var image_file_name_P_T3S1D2 = [];
   var chart_P_T3S1D2 = [];
   var task_P_T3S1D2 = [];
   var trial_P_T3S1D2 = [];
   var sequence_P_T3S1D2 = [];
   var feedback_P_T3S1D2 = [];
   var feedback_time_P_T3S1D2 = [];
      ...
      $("#btn_<?php echo $id;?>").hide();
       ...
       function show_images_P_T3S1D2(n){
            if( image_index_P_T3S1D2 === trial_image_count_P_T3S1D2){
                $("#btn_next_correct_modal_P_T3S1D2").hide();
                $("#btn_next_error_modal_P_T3S1D2").hide();
                $('#btn_next_correct_modal_message_P_T3S1D2').removeClass("d-none");
             ...
             if( image_index_P_T3S1D2 > trial_image_count_P_T3S1D2){
              ...
              $("#header_question_P_T3S1D2").hide();
               $("#btn_<?php echo $id;?>").show();
               return;
             }
             var i_P_T3S1D2;
             var slides_P_T3S1D2 = document.getElementsByClassName("trial_images_P_T3S1D2");
             if (n > slides_P_T3S1D2.length) {image_index_P_T3S1D2 = 1}
             if (n < 1) {image_index_P_T3S1D2 = slides_P_T3S1D2.length}
             for (i_P_T3S1D2 = 0; i_P_T3S1D2 < slides_P_T3S1D2.length; i_P_T3S1D2++) {
                 slides_P_T3S1D2[i_P_T3S1D2].style.display = "none";
             }
             slides_P_T3S1D2[image_index_P_T3S1D2-1].style.display = "block";
             $('#current_trial_image_name_P_T3S1D2').val();
             // console.log(slides_P_T3S1D2[image_index_P_T3S1D2-1].id);
       ...
       var progress_bar_interval_P_T3S1D2;
       function clear_modal_progress_bar_interval_P_T3S1D2(){
         clearInterval(progress_bar_interval_P_T3S1D2);
       }
       function fill_progress_bar_P_T3S1D2(answer){
         var progressBar =  $("#progress_bar_"+answer+"_P_T3S1D2"),
             width = 0;
             progressBar.width(width);
             progress_bar_interval_P_T3S1D2 = setInterval(function() {
                 width += 2;
                 progressBar.css('width', width + '%');
                 if (width >= 100) {
                     clearInterval(progress_bar_interval_P_T3S1D2);
                     if(answer === "correct"){
                       $('#modal_correct_ans_P_T3S1D2').fadeOut(100,function(){
                           $('#modal_correct_ans_P_T3S1D2').modal('hide');
                       });
                     }
                     if(answer === "error"){
                       $('#modal_error_ans_P_T3S1D2').fadeOut(100,function(){
                           $('#modal_error_ans_P_T3S1D2').modal('hide');
                       });
                     }
       ...
       $("#btn_NO_P_T3S1D2").click(function(){
           ...
           // console.log("Trial No", image_number_P_T3S1D2)
           ...
           if(feedback_match_P_T3S1D2 === 'r'){
             ...
             clear_modal_progress_bar_interval_P_T3S1D2();
             fill_progress_bar_P_T3S1D2("correct");
            $("#btn_next_correct_modal_P_T3S1D2").off('click').on('click', function(){
              clear_modal_progress_bar_interval_P_T3S1D2();
              $("#progress_bar_correct_P_T3S1D2").css('width', 0 + '%');
               $('#modal_correct_ans_P_T3S1D2').modal('toggle');
              //  $('#modal_correct_ans_P_T3S1D2').fadeOut(100,function(){ $('#modal_correct_ans_P_T3S1D2').modal('hide'); });
               next_images_P_T3S1D2(1);
             });
             feedback_P_T3S1D2.push("correct");
             feedback_time_P_T3S1D2.push(time_counter_left_P_T3S1D2 - last_time_count_P_T3S1D2);
           }else{
              $('#modal_error_ans_P_T3S1D2').modal('show');
              clear_modal_progress_bar_interval_P_T3S1D2();
              fill_progress_bar_P_T3S1D2("error");
              $("#btn_next_error_modal_P_T3S1D2").off('click').on('click', function(){
                clear_modal_progress_bar_interval_P_T3S1D2();
                $("#progress_bar_error_P_T3S1D2").css('width', 0 + '%');
                    $('#modal_error_ans_P_T3S1D2').modal('toggle');
           ...
           set_current_time_P_T3S1D2(time_counter_left_P_T3S1D2);
       ...
       $("#btn_YES_P_T3S1D2").click(function(){
           ...
           var end_pos_P_T3S1D2 = current_trial_image_name_P_T3S1D2.indexOf('_',start_pos_P_T3S1D2);
           var image_number_P_T3S1D2 = current_trial_image_name_P_T3S1D2.substring(start_pos_P_T3S1D2,end_pos_P_T3S1D2)
           // console.log("Image Seq", image_number_P_T3S1D2)
           sequence_P_T3S1D2.push(image_number_P_T3S1D2);
           trial_P_T3S1D2.push(image_index_P_T3S1D2);
   ...
   $('body').on('next', function(e, type){
     ...
     var page_name_P_T3S1D2                   = '<?php echo $id;?>';
     ...
     if (type === '<?php echo $id;?>'){
      $.ajax({
           ...
           data        : { 
                                  page_name                   : JSON.stringify(page_name_P_T3S1D2), 
                                  participant_id              : JSON.stringify(participant_id_P_T3S1D2), 
                                  system_generated_id         : JSON.stringify(system_generated_id_P_T3S1D2), 
                                  experiment_sequence         : JSON.stringify(experiment_sequence_P_T3S1D2),
                                  experiment_order            : JSON.stringify(experiment_order_P_T3S1D2),
                                  is_main_trial               : JSON.stringify(is_main_trial_P_T3S1D2),
                                  task                        : JSON.stringify(task_P_T3S1D2),
                                  visualization_size          : JSON.stringify(chart_P_T3S1D2),
                                  trial_order                 : JSON.stringify(trial_P_T3S1D2),
                                  image_file_order            : JSON.stringify(sequence_P_T3S1D2),
                                  answering_time              : JSON.stringify(feedback_time_P_T3S1D2),
                                  answer                      : JSON.stringify(feedback_P_T3S1D2),
                                  image_file_name             : JSON.stringify(image_file_name_P_T3S1D2)
                         }, 
           dataType    : 'json',  
