...
<?php
   ...
   $trial_shuffle_P_T1S3D1 = handleImageimage_file_name_P_T1S3D1($img_start_P_T1S3D1, $img_end_P_T1S3D1, $chart_type_P_T1S3D1);
     
   function handleImageimage_file_name_P_T1S3D1($img_start_P_T1S3D1, $img_end_P_T1S3D1, $chart_type_P_T1S3D1){
...
<div class="row">
   <div class="col">
      <div class="container">
         <div class=mt-3></div>
         <h5 id="header_q_P_T1S3D1">On which day did you sleep longer, Saturday or Sunday?</h5>
            ...
            <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
               <div class="modal-content h-auto rounded-right">
                  ...
                  <div class="modal-footer">
                     ...
                     <button type="button" class="btn btn-dark border rounded-pill shadow-sm mb-1" id="btn_next_correct_modal_P_T1S3D1">NEXT</button>
                  </div>
               </div>
            </div>
         </div>
            ...
            <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
               <div class="modal-content h-auto rounded-right">
                  ...
                  <div class="modal-footer">
                     ...
                     <button type="button" class="btn btn-dark border rounded-pill shadow-sm mb-1" id="btn_next_error_modal_P_T1S3D1">NEXT</button>
                  </div>
               </div>
            </div>
         </div>
...
<script type="text/javascript">
   ...
   $('body').on('next', function(e, type){
     ...
     event.preventDefault();
      ...
      var experiment_order_P_T1S3D1            = 'T1-S3-D1';
