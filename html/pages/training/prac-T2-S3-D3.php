...
<?php
   ...
   $trial_shuffle_P_T2S3D3 = handleImageimage_file_name_P_T2S3D3($img_start_P_T2S3D3, $img_end_P_T2S3D3, $chart_type_P_T2S3D3);
     
   function handleImageimage_file_name_P_T2S3D3($img_start_P_T2S3D3, $img_end_P_T2S3D3, $chart_type_P_T2S3D3){
            ...
            <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
               <div class="modal-content h-auto rounded-right">
                  ...
                  <div class="modal-footer">
                     ...
                     <button type="button" class="btn btn-dark border rounded-pill shadow-sm mb-1" id="btn_next_correct_modal_P_T2S3D3">NEXT</button>
                  </div>
               </div>
            </div>
         </div>
            ...
            <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
               <div class="modal-content h-auto rounded-right">
                  ...
                  <div class="modal-footer">
                     ...
                     <button type="button" class="btn btn-dark border rounded-pill shadow-sm mb-1" id="btn_next_error_modal_P_T2S3D3">NEXT</button>
                  </div>
               </div>
            </div>
         </div>
...
<script type="text/javascript">
   ...
   $('body').on('next', function(e, type){
     ...
     var experiment_order_P_T2S3D3            = 'T2-S3-D3';
