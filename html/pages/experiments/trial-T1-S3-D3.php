                        ...
                        <div class="slideshow-container">
                            ...
                            <div id="gif_trial_images_T1S3D3">
                                  <img  src="img/exp_start2.jpg"/>
                                   <button class="btn" id="btn_trial_images_T1S3D3">Start!</button>
                             </div> 
                                    ...
                                    {  ?>  
                                      ...
                                      <?php } ?>                              
                                        <div class="trial_images_T1S3D3" id="T1S3D3_<?php echo $i_T1S3D3; ?>_<?php echo $practice_trial_shuffle_T1S3D3[$i_T1S3D3] ?>">
                                          <img id="img_T1S3D3_<?php echo $i_T1S3D3 ?><?php echo $practice_trial_shuffle_T1S3D3[$i_T1S3D3] ?>" src="img/<?php echo $chart_type_T1S3D3; ?>/<?php echo $practice_trial_shuffle_T1S3D3[$i_T1S3D3] ?>.png"/>
                                        </div>  
                              <?php } ?>
                              </div>
                            </div>
...
$("#btn_sunday_T1S3D3").click(function(){
    ...
    button_disable_T1S3D3();
    // $(".trial_images_T1S3D3").on('click touch', function () {
    //     next_images_T1S3D3(1);
    //     $("#feedback_correct_T1S3D3_"+current_trial_image_name_T1S3D3).hide();
    //     $("#feedback_error_T1S3D3_"+current_trial_image_name_T1S3D3).hide();
    //  });
