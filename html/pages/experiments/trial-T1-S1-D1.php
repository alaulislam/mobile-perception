...
<?php
  ...
  $practice_trial_shuffle_T1S1D1 = handleImageFIle_S1($img_start_T1S1D1, $img_end_T1S1D1, $chart_type_T1S1D1);
    
  function handleImageFIle_S1($img_start_T1S1D1, $img_end_T1S1D1, $chart_type_T1S1D1){
                ...
                <input type="hidden" id="current_trial_image_name_T1S1D1" value="">
                    <div class="slideshow-container">
                        ...
                        <div id="gif_trial_images_T1S1D1">
                                   ...
                                   <button class="btn" id="btn_trial_images_T1S1D1">Start!</button>
                             </div> 
                        ...
                        <?php
                                ...
                                {  ?>  
                                    ...
                                    <div class="trial_images_T1S1D1" id="T1S1D1_<?php echo $i_T1S1D1; ?>_<?php echo $practice_trial_shuffle_T1S1D1[$i_T1S1D1] ?>" >
                                      <img id="img_T1S1D1_<?php echo $i_T1S1D1 ?><?php echo $practice_trial_shuffle_T1S1D1[$i_T1S1D1] ?>" src="img/<?php echo $chart_type_T1S1D1; ?>/<?php echo $practice_trial_shuffle_T1S1D1[$i_T1S1D1] ?>.png"/>
                                    </div>  
                          <?php } ?>

                                  <!-- <div class="trial_images_T1S1D1" id="T1S1D1ATTN-s1_76_t1lt2lt3r">
...
// function canvas_image_touch_deactive_T1S1D1(){
//   $('.trial_images_T1S1D1').unbind('click touch');  
// }
...
function show_images_T1S1D1(n){
      if( image_index_T1S1D1 > trial_image_count_T1S1D1){
        ...
        // alert(attention_check_count_T1S1D1);
        return;
      }
      var i;
