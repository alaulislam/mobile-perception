    ...
    <div class="col">
      ...
      ?>
       <div class="container">
        ...
        <p class="text-justify">
        Alaul Islam <span class="text-muted">(Inria & Université Paris-Saclay, France)</span>, Petra Isenberg <span class="text-muted">(Inria & Université Paris-Saclay, France)</span>, 
        Anastasia Bezerianos <span class="text-muted">(Université Paris Saclay, France)</span>, and Tanja Blascheck <span class="text-muted">(University of Stuttgart, Germany)</span>
