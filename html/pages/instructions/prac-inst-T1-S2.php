<style>
.training_T1S2_page_slide:not(:first-child) {
    display: none;
}
.controls {
    width: 200px;
...
.training_T1S2_page_understand_btn {
    float: right;
}
...
<div class="row">
  ...
  <div class="mt-1 d-flex justify-content-center section-header">
    ...
    <div id="training_T1S2">
        <div class="visible training_T1S2_page_slide">
           <p>&#10148; During your training trials, you will be shown the same Wide size images as before but the image will vary each time.</p>
           <p>&#10148; If you sleep longer on Saturday or Sunday, press the answer button (Sat = Saturday or Sun = Sunday).</p>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <h5 class="d-inline-block align-middle text-muted training_T1S2_counter_display"></h5>
                    <button type="button" class="btn btn-warning training_T1S2_page_understand_btn" style="width:80%">I understand</button>
                </div>
            </div>
    ...
    <div id="training_T1S2_page_comment">
...
$(document).ready(function() {
    ...
    function updateDisplay(){
        $('.training_T1S2_counter_display').text(count +"/3")
    };

    updateDisplay();
    
    $("#training_T1S2_page_comment").hide();
    $("#btn_<?php echo $id;?>").hide();
    $(".training_T1S2_page_understand_btn").click(function() {
      count++;
      updateDisplay();
      var current_div = $('#training_T1S2 .training_T1S2_page_slide.visible').first();
      var next_div = current_div.next();
      current_div.removeClass("visible").hide();
      next_div.addClass("visible").show();
      if (!next_div.next().length) {
          $('.training_T1S2_counter_display').hide();
          $('.training_T1S2_page_understand_btn').hide();
          $("#training_T1S2_page_comment").show();
