<style>
.training_T3S2_page_slide:not(:first-child) {
    display: none;
}
.controls {
    width: 200px;
...
.training_T3S2_page_understand_btn {
    float: right;
}
...
<div class="row">
  ...
  <h4>Training Instructions: Wide size visualization</h4>
      </div>

    <div id="training_T3S2">
        <div class="visible training_T3S2_page_slide">
           ...
           <figure class="img-container" style="margin-top:-10px">
            ...
            <div class="row" style="margin-top:10px">
                <div class="col-sm-12">
                    <h5 class="d-inline-block align-middle text-muted training_T3S2_counter_display"></h5>
                    <button type="button" class="btn btn-warning training_T3S2_page_understand_btn" style="width:80%">I understand</button>
                </div>
            </div>
        ...
        <div class="visible training_T3S2_page_slide">
           ...
           <div class="img-container">
                    <img src="img/instruction/click-S2.png" style="width:180px !important; margin-top:-15px"  alt="Task one answer button">
            </div>
    ...
    <div id="training_T3S2_page_comment">
...
$(document).ready(function() {
    ...
    function updateDisplay(){
        $('.training_T3S2_counter_display').text(count +"/3")
    };

    updateDisplay();
    
    $("#training_T3S2_page_comment").hide();
    $("#btn_<?php echo $id;?>").hide();
    $(".training_T3S2_page_understand_btn").click(function() {
      count++;
      updateDisplay();
      var current_div = $('#training_T3S2 .training_T3S2_page_slide.visible').first();
      var next_div = current_div.next();
      current_div.removeClass("visible").hide();
      next_div.addClass("visible").show();
      if (!next_div.next().length) {
          $('.training_T3S2_counter_display').hide();
          $('.training_T3S2_page_understand_btn').hide();
          $("#training_T3S2_page_comment").show();
