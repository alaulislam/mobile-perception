            ...
            <div class="slideshow-container">
               <div class="slideshow-inner justify-content-center ">
                  <div id="gif_trial_images_T1S3D2">
                     ...
                     <button class="btn glow-on-hover" id="btn_trial_images_T1S3D2">Start!</button>
                  </div>
                  <div id="div_trial_images_T1S3D2" style="display:none">
                     ...
                     <div class="trial_images_T1S3D2" id="T1S3D2_<?php echo $i_T1S3D2; ?>_<?php echo $practice_trial_shuffle_T1S3D2[$i_T1S3D2] ?>">
                        <img id="img_T1S3D2_<?php echo $i_T1S3D2 ?>_<?php echo $practice_trial_shuffle_T1S3D2[$i_T1S3D2] ?>" src="img/<?php echo $chart_type_T1S3D2; ?>/<?php echo $practice_trial_shuffle_T1S3D2[$i_T1S3D2] ?>.png"/>
                     </div>
                     <?php } ?>
                  </div>
               </div>
