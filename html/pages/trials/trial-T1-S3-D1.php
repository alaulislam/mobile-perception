...
<?php
   ...
   $img_start_T1S3D1 = $image_start_end["D3"][0];
   $img_end_T1S3D1 = $image_start_end["D3"][1]; 
   $chart_type_T1S3D1 = "S2";
            ...
            <div class="slideshow-container">
               <div class="slideshow-inner justify-content-center ">
                  <div id="gif_trial_images_T1S3D1">
                     ...
                     <button class="btn glow-on-hover" id="btn_trial_images_T1S3D1">Start!</button>
                  </div>
                  <div id="div_trial_images_T1S3D1" style="display:none">
                     <?php
                        ...
                        {  ?>  
                     <?php if($i_T1S3D1 == 6){ ?> 
                     <div class="trial_images_T1S3D1" id="T1S3D1-attn-s2_0_t1l">
                        <img  src="img/attention/T1_S2/attn-s2_0_t1l.png"/>
                     </div>
                     <?php } ?>
                     <?php if($i_T1S3D1 == 13){ ?> 
                     <div class="trial_images_T1S3D1" id="T1S3D1-attn-s2_1_t1r">
                        <img  src="img/attention/T1_S2/attn-s2_1_t1r.png"/>
                     </div>
                     <?php } ?>
                     <?php if($i_T1S3D1 == 20){ ?> 
                     <div class="trial_images_T1S3D1" id="T1S3D1-attn-s2_2_t1l">
                        <img  src="img/attention/T1_S2/attn-s2_2_t1l.png"/>
                     </div>
                     <?php } ?>
                     <?php if($i_T1S3D1 == 27){ ?> 
                     <div class="trial_images_T1S3D1" id="T1S3D1-attn-s2_3_t1r">
                     ...
                     <div class="trial_images_T1S3D1" id="T1S3D1_<?php echo $i_T1S3D1; ?>_<?php echo $practice_trial_shuffle_T1S3D1[$i_T1S3D1] ?>" >
                        <img id="img_T1S3D1_<?php echo $i_T1S3D1 ?>_<?php echo $practice_trial_shuffle_T1S3D1[$i_T1S3D1] ?>" src="img/<?php echo $chart_type_T1S3D1; ?>/<?php echo $practice_trial_shuffle_T1S3D1[$i_T1S3D1] ?>.png"/>
                     </div>
                     <?php } ?>
                  </div>
               </div>
