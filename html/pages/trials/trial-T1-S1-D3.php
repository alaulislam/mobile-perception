...
<?php
   ...
   $practice_trial_shuffle_T1S1D3 = handleImageFIle_T1S1D3($img_start_T1S1D3, $img_end_T1S1D3, $chart_type_T1S1D3);
     
   function handleImageFIle_T1S1D3($img_start_T1S1D3, $img_end_T1S1D3, $chart_type_T1S1D3){
               ...
               <div class="slideshow-inner justify-content-center ">
                  ...
                  <div id="div_trial_images_T1S1D3" style="display:none">
                     ...
                     <div class="trial_images_T1S1D3" id="T1S1D3_<?php echo $i_T1S1D3; ?>_<?php echo $practice_trial_shuffle_T1S1D3[$i_T1S1D3] ?>" >
                        <img id="img_T1S1D3_<?php echo $i_T1S1D3 ?>_<?php echo $practice_trial_shuffle_T1S1D3[$i_T1S1D3] ?>" src="img/<?php echo $chart_type_T1S1D3; ?>/<?php echo $practice_trial_shuffle_T1S1D3[$i_T1S1D3] ?>.png"/>
                     </div>
                     <?php } ?>
                  </div>
               </div>
