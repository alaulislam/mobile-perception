            ...
            <div class="slideshow-container">
               <div class="slideshow-inner justify-content-center ">
                  ...
                  <div id="div_trial_images_T_T1S1D3" style="display:none">
                     ...
                     <?php } ?>
                     <div class="trial_images_T1S1D3" id="T1S1D3-<?php echo $i_T1S1D3; ?>-<?php echo $trial_image_shuffle_T_T1S1D3[$i_T1S1D3] ?>" >
                        <img id="img-T1S1D3-<?php echo $i_T1S1D3 ?>-<?php echo $trial_image_shuffle_T_T1S1D3[$i_T1S1D3] ?>" src="img/<?php echo $chart_type_T_T1S1D3; ?>/<?php echo $trial_image_shuffle_T_T1S1D3[$i_T1S1D3] ?>.png"/>
                     </div>
                     <?php } ?>
                  </div>
               </div>
...
<script type="text/javascript">
   ...
   var attention_check_flag_T_T1S1D3 = false;
   var attention_check_counter_T_T1S1D3 = 0;
   ...
   $("#btn_sunday_T_T1S1D3").click(function(){
           ...
           var attention_check_img_T_T1S1D3 = current_trial_image_name_T_T1S1D3.startsWith("T1S1D3-attn-");
           if(attention_check_img_T_T1S1D3){
            attention_check_flag_T_T1S1D3 = true;
           }
           ...
           if(feedback_match === 'r'){
             ...
             feedback_time_T_T1S1D3.push(time_counter_sunday_btn_T_T1S1D3 - last_time_count_T_T1S1D3);
             if(attention_check_flag_T_T1S1D3){
               attention_check_counter_T_T1S1D3+=1;
             }
           }
           attention_check_flag_T_T1S1D3 = false;
   ...
   $('body').on('next', function(e, type){
      ...
      if (type === '<?php echo $id;?>'){
      var global_attn_check_fail_count_T_T1S1D3       = parseInt($('#attention_check_fail_count').val());
      var curr_page_attn_check_fail_count_T_T1S1D3    = parseInt(attention_check_counter_T_T1S1D3);
      $('#attention_check_fail_count').val(global_attn_check_fail_count_T_T1S1D3 + curr_page_attn_check_fail_count_T_T1S1D3);
      // var attention_check_fail_count_T_T1S1D3         = parseInt($('#attention_check_fail_count').val());
      // console.log('attention check counter', attention_check_fail_count_T_T1S1D3)
