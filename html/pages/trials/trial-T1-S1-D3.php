...
<?php
     ...
     $trial_image_shuffle_T_T1S1D3 = handleImageimage_T_T1S1D3($img_start_T_T1S1D3, $img_end_T_T1S1D3, $chart_type_T_T1S1D3);
       
     function handleImageimage_T_T1S1D3($img_start_T_T1S1D3, $img_end_T_T1S1D3, $chart_type_T_T1S1D3){
...
<script type="text/javascript">
   ...
   function button_enable_T_T1S1D3(){
       $('#btn_saturday_T_T1S1D3').prop('disabled', false);
       $('#btn_sunday_T_T1S1D3').prop('disabled', false);
   }
   function button_disable_T_T1S1D3(){
       $('#btn_saturday_T_T1S1D3').prop('disabled', true);
       $('#btn_sunday_T_T1S1D3').prop('disabled', true);     
   }
   
   function show_images_T_T1S1D3(n){
         if( image_index_T_T1S1D3 > trial_image_count_T_T1S1D3){
         //   button_disable_T_T1S1D3();
   ...
   $("#btn_sunday_T_T1S1D3").click(function(){
      ...
      //  if(!attention_check){
           time_counter_sunday_btn_T1S1D3 = performance.now();
           ...
           if(feedback_match === 'r'){
             ...
             feedback_time_T_T1S1D3.push(time_counter_sunday_btn_T1S1D3 - last_time_count_T_T1S1D3);
           }else{
             feedback_T_T1S1D3.push("error");
             feedback_time_T_T1S1D3.push(time_counter_sunday_btn_T1S1D3 - last_time_count_T_T1S1D3);
           }
           set_current_time_T_T1S1D3(time_counter_sunday_btn_T1S1D3);
   ...
   $("#btn_saturday_T_T1S1D3").click(function(){
       var current_trial_image_name_T_T1S1D3 = $('#current_trial_image_name_T_T1S1D3').val();
           time_counter_saturday_bn_T1S1D3 = performance.now();
           ...
           if(feedback_match === 'l'){
             feedback_T_T1S1D3.push("correct");
             feedback_time_T_T1S1D3.push(time_counter_saturday_bn_T1S1D3 - last_time_count_T_T1S1D3);
           }else{
             feedback_T_T1S1D3.push("error");
             feedback_time_T_T1S1D3.push(time_counter_saturday_bn_T1S1D3 - last_time_count_T_T1S1D3);
           }
   
           set_current_time_T_T1S1D3(time_counter_saturday_bn_T1S1D3);
           next_images_T_T1S1D3(1);
   ...
   $('body').on('next', function(e, type){
      ...
      var experiment_order_T_T1S1D3          = 'T1-S1-D3';
