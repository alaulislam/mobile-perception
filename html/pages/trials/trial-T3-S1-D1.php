...
<?php
   ...
   $experiment_order_T_T3S1D1 = 'T3-S1-D1';
   ...
   $trial_image_shuffle_T_T3S1D1 = handleImageFIle_T_T3S1D1($img_start_T_T3S1D1, $img_end_T_T3S1D1, $chart_type_T_T3S1D1);
     
   function handleImageFIle_T_T3S1D1($img_start_T_T3S1D1, $img_end_T_T3S1D1, $chart_type_T_T3S1D1){
      ...
      <div class="container">
               ...
               <div class="slideshow-inner justify-content-center ">
                  ...
                  <div id="div_trial_images_T_T3S1D1" style="display:none">
                     <?php
                        ...
                        {  ?>  
                     <?php if($i_T3S1D1 == 6){ ?> 
                     <div class="trial_images_T_T3S1D1" id="T3S1D1-attn-s1_300_t3l">
                        <img  src="img/attention/T3_S1/attn-s1_300_t3l.png"/>
                     </div>
                     <?php } ?>
                     <?php if($i_T3S1D1 == 13){ ?> 
                     <div class="trial_images_T_T3S1D1" id="T3S1D1-attn-s1_301_t3r">
                        <img  src="img/attention/T3_S1/attn-s1_301_t3r.png"/>
                     </div>
                     <?php } ?>
                     <?php if($i_T3S1D1 == 20){ ?> 
                     <div class="trial_images_T_T3S1D1" id="T3S1D1-attn-s1_302_t3l">
                        <img  src="img/attention/T3_S1/attn-s1_302_t3l.png"/>
                     </div>
                     <?php } ?>
                     <?php if($i_T3S1D1 == 27){ ?> 
                     <div class="trial_images_T_T3S1D1" id="T3S1D1-attn-s1_303_t3r">
                        <img  src="img/attention/T3_S1/attn-s1_303_t3r.png"/>
                     </div>
                     <?php } ?>
                     <div class="trial_images_T_T3S1D1" id="T3S1D1-<?php echo $i_T3S1D1; ?>-<?php echo $trial_image_shuffle_T_T3S1D1[$i_T3S1D1] ?>" >
                        <img id="img-T3S1D1-<?php echo $i_T3S1D1 ?>-<?php echo $trial_image_shuffle_T_T3S1D1[$i_T3S1D1] ?>" src="img/<?php echo $chart_type_T_T3S1D1; ?>/<?php echo $trial_image_shuffle_T_T3S1D1[$i_T3S1D1] ?>.png"/>
                     </div>
                     <?php } ?>
                  </div>
               </div>
         ...
         <div class="d-flex justify-content-center" id="div_trainging_ans_buttons_T_T3S1D1">
            <div class = "btn-group-justified btn-group-lg btn-group-horizontal">
               <button type="button" id="btn_NO_T_T3S1D1" class="btn btn-info">No</button>
               <button type="button" id="btn_YES_T_T3S1D1" class="btn btn-info" style="margin-right: 15px;">Yes</button>
            </div>
         </div>
...
<script type="text/javascript">
   ...
   var attention_check_flag_T_T3S1D1 = false;
   var attention_check_counter_T_T3S1D1 = 0;
   $(document).ready(function() {
    $("#btn_<?php echo $id;?>").hide();
     $("#btn_NO_T_T3S1D1").hide();
     $("#btn_YES_T_T3S1D1").hide();
   
     $("#btn_trial_images_T_T3S1D1").click(function(){
       $("#gif_trial_images_T_T3S1D1").hide();
       $('#div_trial_images_T_T3S1D1').show();
       $("#btn_NO_T_T3S1D1").show();
       $("#btn_YES_T_T3S1D1").show();
     }); 
   ...
   function show_images_T_T3S1D1(n){
         ...
         var i;
         var slides_T_T3S1D1 = document.getElementsByClassName("trial_images_T_T3S1D1");
   ...
   $("#btn_NO_T_T3S1D1").click(function(){
          var current_trial_image_name_T_T3S1D1 = $('#current_trial_image_name_T_T3S1D1').val();
          var attention_check_img_T_T3S1D1 = current_trial_image_name_T_T3S1D1.startsWith("T3S1D1-attn-");
           if(attention_check_img_T_T3S1D1){
            attention_check_flag_T_T3S1D1 = true;
           }
           time_counter_no_bn_T3S1D1 = performance.now();
           ...
           if(feedback_match === 'r'){
            //   alert('correct');
             ...
             feedback_time_T_T3S1D1.push(time_counter_no_bn_T3S1D1 - last_time_count_T_T3S1D1);
           }else{
            //  alert('wrong');
             feedback_T_T3S1D1.push("error");
             feedback_time_T_T3S1D1.push(time_counter_no_bn_T3S1D1 - last_time_count_T_T3S1D1);
             if(attention_check_flag_T_T3S1D1){
               attention_check_counter_T_T3S1D1+=1;
             }
           }
           attention_check_flag_T_T3S1D1 = false;
           set_current_time_T_T3S1D1(time_counter_no_bn_T3S1D1);
           next_images_T_T3S1D1(1);
      
   }); 
   
   $("#btn_YES_T_T3S1D1").click(function(){
           var current_trial_image_name_T_T3S1D1 = $('#current_trial_image_name_T_T3S1D1').val();
           var attention_check_img_T_T3S1D1 = current_trial_image_name_T_T3S1D1.startsWith("T3S1D1-attn-");
           if(attention_check_img_T_T3S1D1){
            attention_check_flag_T_T3S1D1 = true;
           }
           time_counter_yes_bn_T3S1D1 = performance.now();
           image_file_name_T_T3S1D1.push(current_trial_image_name_T_T3S1D1);
           chart_T_T3S1D1.push(stimuli_T_T3S1D1);
           task_T_T3S1D1.push("t3");
           var start_pos = current_trial_image_name_T_T3S1D1.indexOf('_') + 1;
           ...
           if(feedback_match === 'l'){
            //  alert('correct');
             feedback_T_T3S1D1.push("correct");
             feedback_time_T_T3S1D1.push(time_counter_yes_bn_T3S1D1 - last_time_count_T_T3S1D1);
           }else{
            // alert('wrong');
             feedback_T_T3S1D1.push("error");
             feedback_time_T_T3S1D1.push(time_counter_yes_bn_T3S1D1 - last_time_count_T_T3S1D1);
           ...
           set_current_time_T_T3S1D1(time_counter_yes_bn_T3S1D1);
           next_images_T_T3S1D1(1);
   }); 
   ...
   $('body').on('next', function(e, type){
     ...
     event.preventDefault();
      ...
      var experiment_order_T_T3S1D1         = '<?php echo $experiment_order_T_T3S1D1;?>';
      var is_main_trial_T_T3S1D1            = 1;
     if (type === '<?php echo $id;?>'){
      var global_attn_check_fail_count_T_T3S1D1       = parseInt($('#attention_check_fail_count').val());
      var curr_page_attn_check_fail_count_T_T3S1D1    = parseInt(attention_check_counter_T_T3S1D1);
      $('#attention_check_fail_count').val(global_attn_check_fail_count_T_T3S1D1 + curr_page_attn_check_fail_count_T_T3S1D1);
      $.ajax({
           type        : 'POST',  
