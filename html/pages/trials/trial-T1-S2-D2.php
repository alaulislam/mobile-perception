...
<?php
     ...
     $trial_image_shuffle_T_T1S2D2 = handleImageimage_T_T1S2D2($img_start_T_T1S2D2, $img_end_T_T1S2D2, $chart_type_T_T1S2D2);
       
     function handleImageimage_T_T1S2D2($img_start_T_T1S2D2, $img_end_T_T1S2D2, $chart_type_T_T1S2D2){
            ...
            <div class="slideshow-container">
               <div class="slideshow-inner justify-content-center ">
                  ...
                  <div id="div_trial_images_T_T1S2D2" style="display:none">
                     ...
                     <?php } ?>
                     <div class="trial_images_T1S2D2" id="T1S2D2_<?php echo $i_T1S2D2; ?>_<?php echo $trial_image_shuffle_T_T1S2D2[$i_T1S2D2] ?>" >
                        <img id="img_T1S2D2_<?php echo $i_T1S2D2 ?>_<?php echo $trial_image_shuffle_T_T1S2D2[$i_T1S2D2] ?>" src="img/<?php echo $chart_type_T_T1S2D2; ?>/<?php echo $trial_image_shuffle_T_T1S2D2[$i_T1S2D2] ?>.png"/>
                     </div>
                     <?php } ?>
                  </div>
               </div>
...
<script type="text/javascript">
   ...
   function button_enable_T_T1S2D2(){
       $('#btn_saturday_T_T1S2D2').prop('disabled', false);
       $('#btn_sunday_T_T1S2D2').prop('disabled', false);
   }
   function button_disable_T_T1S2D2(){
       $('#btn_saturday_T_T1S2D2').prop('disabled', true);
       $('#btn_sunday_T_T1S2D2').prop('disabled', true);     
   }
   
   function show_images_T_T1S2D2(n){
         if( image_index_T_T1S2D2 > trial_image_count_T_T1S2D2){
         //   button_disable_T_T1S2D2();
   ...
   $("#btn_sunday_T_T1S2D2").click(function(){
      ...
      //  var attention_check = current_trial_image_name_T_T1S2D2.startsWith("T1S2D2ATTN-");
      //  if(!attention_check){
           time_counter_sunday_btn_T1S2D2 = performance.now();
           ...
           if(feedback_match === 'r'){
             ...
             feedback_time_T_T1S2D2.push(time_counter_sunday_btn_T1S2D2 - last_time_count_T_T1S2D2);
           }else{
             feedback_T_T1S2D2.push("error");
             feedback_time_T_T1S2D2.push(time_counter_sunday_btn_T1S2D2 - last_time_count_T_T1S2D2);
           }
           set_current_time_T_T1S2D2(time_counter_sunday_btn_T1S2D2);
   ...
   $("#btn_saturday_T_T1S2D2").click(function(){
       var current_trial_image_name_T_T1S2D2 = $('#current_trial_image_name_T_T1S2D2').val();
           time_counter_saturday_bn_T1S2D2 = performance.now();
           ...
           if(feedback_match === 'l'){
             feedback_T_T1S2D2.push("correct");
             feedback_time_T_T1S2D2.push(time_counter_saturday_bn_T1S2D2 - last_time_count_T_T1S2D2);
           }else{
             feedback_T_T1S2D2.push("error");
             feedback_time_T_T1S2D2.push(time_counter_saturday_bn_T1S2D2 - last_time_count_T_T1S2D2);
           }
   
           set_current_time_T_T1S2D2(time_counter_saturday_bn_T1S2D2);
           next_images_T_T1S2D2(1);
   ...
   $('body').on('next', function(e, type){
      ...
      var experiment_order_T_T1S2D2          = 'T1-S2-D2';
