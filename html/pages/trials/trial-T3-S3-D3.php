            ...
            <div class="slideshow-container">
               <div class="slideshow-inner justify-content-center ">
                  <div id="gif_trial_images_T3S3D3">
                     ...
                     <button class="btn glow-on-hover" id="btn_trial_images_T3S3D3">Start!</button>
                  </div>
                  <div id="div_trial_images_T3S3D3" style="display:none">
                     ...
                     <div class="trial_images_T3S3D3" id="T3S3D3_<?php echo $i_T3S3D3; ?>_<?php echo $practice_trial_shuffle_T3S3D3[$i_T3S3D3] ?>">
                        <img id="img_T3S3D3_<?php echo $i_T3S3D3 ?>_<?php echo $practice_trial_shuffle_T3S3D3[$i_T3S3D3] ?>" src="img/<?php echo $chart_type_T3S3D3; ?>/<?php echo $practice_trial_shuffle_T3S3D3[$i_T3S3D3] ?>.png"/>
                     </div>
                     <?php } ?>
                  </div>
               </div>
