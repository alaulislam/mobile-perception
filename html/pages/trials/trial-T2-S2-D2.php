         ...
         <div class="slideshow-container">
            <div class="slideshow-inner justify-content-center ">
               <div id="gif_trial_images_T2S2D2">
                  ...
                  <button class="btn glow-on-hover" id="btn_trial_images_T2S2D2">Start!</button>
               </div>
               <div id="div_trial_images_T2S2D2" style="display:none">
                  ...
                  <div class="trial_images_T2S2D2" id="T2S2D2_<?php echo $i_T2S2D2; ?>_<?php echo $practice_trial_shuffle_T2S2D2[$i_T2S2D2] ?>">
                     <img id="img_T2S2D2_<?php echo $i_T2S2D2 ?>_<?php echo $practice_trial_shuffle_T2S2D2[$i_T2S2D2] ?>" src="img/<?php echo $chart_type_T2S2D2; ?>/<?php echo $practice_trial_shuffle_T2S2D2[$i_T2S2D2] ?>.png"/>
                  </div>
                  <?php } ?>
               </div>
            </div>
